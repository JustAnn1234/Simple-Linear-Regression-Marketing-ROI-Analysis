...
Marketing and sales regression_analysis.ipynb: The core Jupyter Notebook containing all data cleaning, EDA, OLS model output, and diagnostic assumption plots.
